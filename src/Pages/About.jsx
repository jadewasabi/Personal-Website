        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I developed my portfolio alongside YouTube Tutorials, React Bits, Tailwinds, Node and Next.js. I've been 
             practicing React Class since 8th Grade--4 years ago. The Personal Website Portfolio Project helped me to finally 
             embrace my 4 years of going insane. The program I mentioned was a big help in executing animations and frames in this projects,
             the concept of this website is also built along templates components that I extracted for creativity. However, 
             my projects and certificate containers are still empty because this portfolio is the only project I've accomplished so far. 
                  </p>
