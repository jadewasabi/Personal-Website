...
const WORDS = ["Computer Programming Student", "Aspiring Web Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/jadewasabi", label: "GitHub Profile" },
  { icon: Instagram, link: "https://www.instagram.com/xjdeun/?__pwa=1", label: "Instagram Profile" }
];
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Contains personal details, accomplished projects count, achievements and made alongside Reactbits for components 
                    and also Tailwind, Javascript alongside Next.js for implications. I was almost sent to Psych Ward thnaks to Youtube tutorials
                    I learned how to execute these typescripts before going insane. 
                  </p>
